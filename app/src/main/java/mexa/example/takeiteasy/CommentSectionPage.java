...
public class CommentSectionPage extends AppCompatActivity {
    ...
    public byte encryptionKey[]={9,115,51,86,105,4,-31,-23,-68,88,17,20,3,-103,119,-53};
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_comment_section_page);
        use=getIntent().getExtras().getString("ChatName");
            ...
            databaseReference.addValueEventListener(new ValueEventListener() {
                ...
                public void onDataChange(@NonNull DataSnapshot snapshot) {
                    ...
                    try {
                        ...
                        listView.setAdapter(new ArrayAdapter<String>(CommentSectionPage.this, android.R.layout.simple_list_item_1, stringFinal));
                    }catch (Exception e){
                        e.printStackTrace();
                    }
    ...
    public void sendButton(View view){
        Date date=new Date();
        databaseReference.child(Long.toString(date.getTime())).setValue(AESEncryptionMethod(use+": "+editText.getText().toString()));
        editText.setText("");
    }
